package com.cindytech.isecure.db;
...
import com.cindytech.isecure.ui.home.HomeFragment;

import java.text.SimpleDateFormat;
import java.util.Date;

public class HomeDB extends SQLiteOpenHelper {
    ...
    public HomeDB(@Nullable HomeFragment context) {
        super(context.getContext(), "model.db", null, 1);
    }
